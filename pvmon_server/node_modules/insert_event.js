...
module.exports.process = function(req,res,body) {
	...
	var insert_event_final_callback = function() {
		//console.log('callback='+count_callbacks+' => '+(count_callbacks-1));
		count_callbacks--;
	...
	try {
		...
		events.forEach(function(ev) {
			...
			if(ev.hasOwnProperty('state')) {
				...
				count_callbacks++;
				rs.insert_event(ev,insert_event_final_callback);
			...
			if(ev.hasOwnProperty('metric')) {
				// I push it to statsd
				count_callbacks++;
				statsd.insert_event(ev,insert_event_final_callback);
			}
